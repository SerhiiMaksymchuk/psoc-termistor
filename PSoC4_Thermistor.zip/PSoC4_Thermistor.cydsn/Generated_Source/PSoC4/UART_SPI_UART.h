...
#define UART_SPI_INTERRUPT_ENABLE   ((UART_SPI_INTERRUPT_MODE == \
                                                    UART_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))

/* Enable UART mode interrupt */
#define UART_UART_INTERRUPT_ENABLE  ((UART_UART_INTERRUPT_MODE == \
                                                    UART_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))
    ...
    #define UART_CHECK_UART_WAKE_ENABLE (0u != UART_scbEnableWake)
    ...
    /* Get wakeup enable option */
    #define UART_CHECK_SPI_WAKE_ENABLE  (0u != UART_SPI_WAKE_ENABLE)
    #define UART_CHECK_UART_WAKE_ENABLE (0u != UART_UART_WAKE_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define UART_SPI_INTERRUPT_DISABLE          (0u == UART_SPI_INTERRUPT_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define UART_UART_INTERRUPT_DISABLE         (0u == UART_UART_INTERRUPT_ENABLE)
